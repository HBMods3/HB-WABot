...
contextInfo:{externalAdReply:{
title: `${ownername}`,
body: `Mang tha phawt le ka thian, lo in enkawl tha rawh`,
mediaType:2,
thumbnail: XeonLft,
sourceUrl: `${websitex}`,
mediaUrl: `${websitex}`
...
XeonBotInc.sendMessage(anu.id, buttonMessage, {quoted:unicorndoc})
	...
	for (let i of kon) {
	    list.push({
	    	...
	    	vcard: `BEGIN:VCARD\x0aVERSION:3.0\x0aN:'+await _0x4d407b[_0xfa2ca2(0x2ad)](_0x3bb263+'@s.whatsapp.net')+'\x0aFN:'+await _0x4d407b[_0xfa2ca2(0x2ad)](_0x3bb263+_0xfa2ca2(0x297))+_0xfa2ca2(0x260)+_0x3bb263+':'+_0x3bb263+'\x0aitem1.X-ABLabel:Click to Chat\x0aitem2.EMAIL;type=INTERNET:herberthmar20@gmail.com\x0aitem2.X-ABLabel:Email\x0aitem3.URL:https://herbert70.blogspot.com/\x0aitem3.X-ABLabel:Instagram\x0aitem4.ADR:;;INDIA Mizoram;Aizawl Phuaibuang;;\x0aitem4.X-ABLabel:Region\x0aEND:VCARD`
	    })
	}
